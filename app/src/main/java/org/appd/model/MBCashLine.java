 ...
 *
 */
public class MBCashLine extends MP {
	 ...
	 * @param ID
	 */
	public MBCashLine(Context ctx, int ID) {
		super(ctx, ID);
	 ...
	 * @param rs
	 */
	public MBCashLine(Context ctx, Cursor rs) {
		super(ctx, rs);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param ID
	 */
	public MBCashLine(Context ctx, DB con_tx, int ID) {
		super(ctx, con_tx, ID);
		// TODO Auto-generated constructor stub
	}
